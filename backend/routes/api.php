...
Route::prefix('/customer/{slug}')->middleware(['web', 'tenant.customer'])->group(function () {
    ...
    Route::post('/reset-password', [CustomerPortalController::class, 'resetPassword']);
    ...
    Route::put('/password', [CustomerPortalController::class, 'updatePassword'])->middleware('customer.auth');
    Route::get('/notifications', [CustomerPortalController::class, 'notifications'])->middleware('customer.auth');
    Route::post('/notifications/read', [CustomerPortalController::class, 'readNotifications'])->middleware('customer.auth');
    Route::post('/notifications/{notification}/read', [CustomerPortalController::class, 'readNotification'])->middleware('customer.auth');
    Route::post('/broadcasting/auth', [CustomerPortalController::class, 'broadcastingAuth'])->middleware('customer.auth');
});
...
Route::middleware(['web', 'auth:sanctum', 'tenant.auth'])->group(function () {
    ...
    Route::post('/notifications/{notification}/read', [AuthController::class, 'readNotification']);
...
Route::prefix('/admin')->middleware(['web', 'auth:sanctum', 'tenant.auth', 'super.admin'])->group(function () {
    ...
    Route::get('/businesses/{business}/activity', [AdminController::class, 'businessActivity']);
